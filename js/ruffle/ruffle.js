(() => {
    ...
    var e, n, t = {
            ...
            53: (e, n, t) => {
                Object.defineProperty(n, "__esModule", {
                    value: !0
                }), n.createRef = n.h = void 0, n.createElement = o;
                const a = t(136),
                    r = t(56);
            ...
            56: (e, n) => {
                ...
                Object.defineProperty(n, "__esModule", {
                    ...
                    let t = e,
                        a = n;
                    a && "tsxTag" in a && (t = a.tsxTag, !a.is && e.includes("-") && (a = { ...a,
                        is: e
                    }));
                    return {
                        finalTag: t,
            ...
            136: (e, n, t) => {
                Object.defineProperty(n, "__esModule", {
                    ...
                    for (const t of Object.keys(n)) {
                        ...
                        } else "style" === t && "string" != typeof i ? r(i, e.style) : "dangerouslySetInnerHTML" === t ? e.innerHTML = i : !0 === i ? e.setAttribute(t, t) : (i || 0 === i || "" === i) && e.setAttribute(t, i.toString())
                    }
                };
                const a = t(665);
    ...
    r.m = t, r.d = (e, n) => {
        ...
        482: "7020c4cdffbc0d672689",
        655: "d8020f36e5918e887c19"
    }[e] + ".js", r.g = function() {
    ...
    var c, d, f, m, p, h, v, g, b, w, k, y = r(553);
    ! function(e) {
    ...
    function(e) {
        e.South = "south", e.East = "east", e.North = "north", e.West = "west", e.LeftTrigger = "left-trigger", e.LeftTrigger2 = "left-trigger-2", e.RightTrigger = "right-trigger", e.RightTrigger2 = "right-trigger-2", e.Select = "select", e.Start = "start", e.DPadUp = "dpad-up", e.DPadDown = "dpad-down", e.DPadLeft = "dpad-left", e.DPadRight = "dpad-right"
    }(k || (k = {}));
    const R = {
        allowScriptAccess: !1,
        parameters: {},
    ...
    class S extends x {
        static supportsValue(e) {
            ...
            if ("Temporal" in globalThis) {
                ...
                if (e instanceof n.Instant || e instanceof n.PlainDateTime || e instanceof n.PlainDate || e instanceof n.PlainMonthDay || e instanceof n.PlainTime || e instanceof n.PlainYearMonth) return !0
            }
            return !1
        }
        constructor(e, n = {}) {
            e instanceof S ? (n = { ...e.opts,
                ...n
            }, e = e.value) : e instanceof x && (e = e.valueOf()), "object" == typeof e && "calendarId" in e && void 0 === n.calendar && (n = { ...n,
        ...
        toString(e) {
            ...
            return "number" == typeof this.value || this.value instanceof Date ? new Date(this.value).toISOString() : this.value.toString()
        }
    }
        ...
        switch (n.type) {
            ...
            case "var":
                return function(e, {
                    ...
                    if (e.params) {
                        ...
                        if (!e.args || !Object.prototype.hasOwnProperty.call(e.args, n)) return e.reportError(new ReferenceError(`Unknown variable: $${n}`)), new z(`$${n}`);
                        t = e.args[n]
                    }
            ...
            case "func":
                return function(e, {
                    ...
                    if ("function" != typeof a) return e.reportError(new TypeError(`Function ${n}() is not callable`)), new z(`${n}()`);
                    try {
                        let n = A(e, t);
    ...
    function F(e, n) {
        ...
        for (const r of n)
            if ("string" != typeof r) {
                if (e.placeables++, e.placeables > 100) throw e.dirty.delete(n), new RangeError(`Too many placeables expanded: ${e.placeables}, max allowed is 100`);
    ...
    function O(e, n) {
        ...
        if (t instanceof j) return new j(t.valueOf(), { ...t.opts,
            ...M(n, $)
        });
    ...
    const I = ["dateStyle", "timeStyle", "fractionalSecondDigits", "dayPeriod", "hour12", "weekday", "era", "year", "month", "day", "hour", "minute", "second", "timeZoneName"];
    ...
    class de {
        constructor(e) {
            ...
            function m() {
                let e;
                return r(re, SyntaxError), e = t(B) ? h() : {
                    type: "str",
                    value: i(V)
                }, r(oe, SyntaxError), e
            }
    ...
    const me = new RegExp("^([a-z]{2,3}|\\*)(?:-([a-z]{4}|\\*))?(?:-([a-z]{2}|\\*))?(?:-(([0-9][a-z0-9]{3}|[a-z0-9]{5,8})|\\*))?$", "i");
    class pe {
        constructor(e) {
    ...
    function ye() {
        "function" == typeof Array.prototype.reduce && ke(Array.prototype.reduce) || Object.defineProperty(Array.prototype, "reduce", {
            value(...e) {
        ...
        }), "function" == typeof Window && ke(Window) || "function" == typeof window.constructor && ke(window.constructor) && (window.Window = window.constructor), void 0 !== window.Reflect && null !== window.Reflect || (window.Reflect = {}), "function" != typeof Reflect.get && Object.defineProperty(Reflect, "get", {
            value: (e, n) => e[n]
    ...
    function je(e, n) {
        const t = be(),
            a = ge(navigator.languages, Object.keys(xe), {
                defaultLocale: "en-US"
            });
        for (const t in a) {
            const r = ze(a[t], e, n);
    ...
    Ee.content.appendChild((0, y.jsx)((function() {
        return (0, y.jsx)("style", {
            ...
            children: (0, y.jsx)("div", {
                ...
                children: (0, y.jsxs)("div", {
                    ...
                    children: [(0, y.jsx)("input", {
                        ...
                        id: "volume-mute",
                        for: "mute-checkbox",
                        title: je("volume-controls-unmute")
                    }), (0, y.jsx)("label", {
                        id: "volume-min",
                        for: "mute-checkbox",
                        title: je("volume-controls-mute")
                    }), (0, y.jsx)("label", {
                        id: "volume-mid",
                        for: "mute-checkbox",
                        title: je("volume-controls-mute")
        ...
        return (0, y.jsx)("div", {
            ...
            children: (0, y.jsxs)("div", {
                ...
                children: [(0, y.jsx)("span", {
                    ...
                    children: je("clipboard-message-title")
                }), (0, y.jsx)("p", {
                    ...
                    children: [(0, y.jsxs)("b", {
                        ...
                        children: je("clipboard-message-copy")
                    })]
                }), (0, y.jsxs)("p", {
                    children: [(0, y.jsxs)("b", {
                        children: [Ce, "+X"]
                    }), (0, y.jsx)("span", {
                        children: je("clipboard-message-cut")
                    })]
                }), (0, y.jsxs)("p", {
                    children: [(0, y.jsxs)("b", {
                        children: [Ce, "+V"]
                    }), (0, y.jsx)("span", {
                        children: je("clipboard-message-paste")
                    })]
                })]
            })
        })
    ...
    try {
        if (document.currentScript instanceof HTMLScriptElement && "" !== document.currentScript.src) {
            ...
            e.endsWith(".js") || e.endsWith("/") || (e += "/"), Me = new URL(".", e), $e = Me.protocol.includes("extension")
        }
    } catch (e) {
        ...
        const r = t.join(""),
            {
                ...
                if (e instanceof Ie) return e.swfUrl && !e.swfUrl.protocol.includes("http") ? {
                ...
                if (e instanceof We) {
                    ...
                    if (n.includes("networkerror") || n.includes("failed to fetch") || n.includes("load failed")) return {
                    ...
                    if ("CompileError" === e.cause.name && n.includes("bad type")) return {
                    ...
                    if ("TypeError" === e.cause.name) {
                        ...
                        return _e() && e.appendChild(Se("error-javascript-conflict-outdated", {
                    ...
                    return navigator.userAgent.includes("Edg") && n.includes("webassembly is not defined") ? {
                        ...
                        actions: [Ue.openWiki("Frequently-Asked-Questions-For-Users#edge-webassembly-error", je("more-info")), Ue.ShowDetails]
                    } : {
            ...
            s = (0, Ne.createRef)(),
            u = () => {
                s.current.classList.add("details"), s.current.replaceChildren((0, y.jsx)("textarea", {
                    readOnly: !0,
                    children: r
                }))
            };
        e.textContent = "", e.appendChild((0, y.jsxs)("div", {
            id: "panic",
            children: [(0, y.jsx)("div", {
                id: "panic-title",
                ...
                children: (0, y.jsx)("ul", {
                    children: i.map((e => function({
                        ...
                        if ("open_link" === e.type) return (0, y.jsx)("li", {
                            children: (0, y.jsx)("a", {
                                href: e.url,
                                target: "_top",
                                children: e.label
                            ...
                            return t.stackIndex > -1 && String(n + o).length > 8195 && (t[t.stackIndex] = null, t.avmStackIndex > -1 && (t[t.avmStackIndex] = null), o = encodeURIComponent(t.join(""))), n += o, (0, y.jsx)("li", {
                                children: (0, y.jsx)("a", {
                                    href: n,
                                    target: "_top",
    ...
    const Ve = async () => WebAssembly.validate(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 5, 3, 1, 0, 1, 10, 14, 1, 12, 0, 65, 0, 65, 0, 65, 0, 252, 10, 0, 0, 11])),
        He = async () => WebAssembly.validate(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 10, 7, 1, 5, 0, 208, 112, 26, 11])),
        Je = async () => WebAssembly.validate(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 10, 12, 1, 10, 0, 67, 0, 0, 0, 0, 252, 0, 26, 11])),
        Ze = async () => WebAssembly.validate(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 10, 8, 1, 6, 0, 65, 0, 192, 26, 11])),
        Ke = async () => WebAssembly.validate(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 5, 1, 96, 0, 1, 123, 3, 2, 1, 0, 10, 10, 1, 8, 0, 65, 0, 253, 15, 253, 98, 11]));
    let Qe = null;
    async function Ge(e) {
        null === Qe && (Qe = async function(e) {
            ye();
            const n = (await Promise.all([Ve(), Ke(), Je(), Ze(), He()])).every(Boolean);
            n || console.log("Some WebAssembly extensions are NOT available, falling back to the vanilla WebAssembly module"), at.options.onFirstLoad ? .(), at.options.onFirstLoad = () => {};
            const {
                default: t,
    ...
    function Xe(e, n) {
        ...
        if (void 0 !== window.customElements)
            for (; a < 999;) {
                let t = e;
                if (a > 0 && (t = t + "-" + a), void 0 === window.customElements.get(t)) return window.customElements.define(t, n), Ye[e] = {
                    class: n,
                    name: t,
                    internalName: e
                }, t;
    ...
    function nn(e, n) {
        if (en(n.allowScriptAccess) && e.setAllowScriptAccess(n.allowScriptAccess), en(n.backgroundColor) && e.setBackgroundColor(function(e) {
    ...
    class sn {
        constructor(e, n, t) {
            this.contextMenuForceDisabled = !1, this.isTouch = !1, this.contextMenuSupported = !1, this._suppressContextMenu = !1, this.panicked = !1, this.rendererDebugInfo = "", this.longPressTimer = null, this.pointerDownPosition = null, this.pointerMoveMaxDistance = 0, this.onFSCommand = [], this.config = {}, this.SaveRow = ({
                rowKey: e,
                solName: n,
                solData: t
            }) => (0, y.jsxs)("tr", {
                children: [(0, y.jsx)("td", {
                    ...
                    children: (0, y.jsx)("span", {
                        ...
                        onClick: () => mn(function(e, n) {
                            const t = pn(e);
                            return new Blob([t], {
                                type: n
                            })
                        }(t, "application/octet-stream"), n + ".sol")
                    })
                }), (0, y.jsxs)("td", {
                    children: [(0, y.jsx)("input", {
                        type: "file",
            ...
            }), this.element = e, this.debugPlayerInfo = n, this.onCallbackAvailable = t, this.shadow = this.element.attachShadow({
                mode: "open",
                delegatesFocus: !0
            }), this.shadow.appendChild(Ee.content.cloneNode(!0)), this.dynamicStyles = this.shadow.getElementById("dynamic-styles"), this.container = this.shadow.getElementById("container"), this.playButton = this.shadow.getElementById("play-button"), this.playButton.addEventListener("click", (() => this.play())), this.unmuteOverlay = this.shadow.getElementById("unmute-overlay"), this.splashScreen = this.shadow.getElementById("splash-screen"), this.virtualKeyboard = this.shadow.getElementById("virtual-keyboard"), this.virtualKeyboard.addEventListener("input", this.virtualKeyboardInput.bind(this)), this.saveManager = this.shadow.getElementById("save-manager"), this.videoModal = this.shadow.getElementById("video-modal"), this.hardwareAccelerationModal = this.shadow.getElementById("hardware-acceleration-modal"), this.volumeControls = this.shadow.getElementById("volume-controls-modal"), this.clipboardModal = this.shadow.getElementById("clipboard-modal"), this.addModalJavaScript(this.saveManager), this.addModalJavaScript(this.volumeControls), this.addModalJavaScript(this.videoModal), this.addModalJavaScript(this.hardwareAccelerationModal), this.addModalJavaScript(this.clipboardModal), this.volumeSettings = new ln(!1, 100), this.addVolumeControlsJavaScript(this.volumeControls);
            ...
            this.contextMenuElement.addEventListener("contextmenu", o), this.contextMenuElement.addEventListener("click", o), this.contextMenuElement.dir = function() {
        ...
        async ensureFreshInstance() {
            ...
            if (this.newZipWriter = n, nn(e, this.loadedConfig || {}), e.setVolume(this.volumeSettings.get_volume()), this.loadedConfig ? .fontSources)
            ...
            if (console.log("%cNew Ruffle instance created (Version: " + l.versionName + " | WebAssembly extensions: " + (a.is_wasm_simd_used() ? "ON" : "OFF") + " | Used renderer: " + (t ? ? "") + ")", "background: #37528C; color: #FFAD33"), "running" !== this.audioState() && (this.container.style.visibility = "hidden", await new Promise((e => {
                ...
                })), this.container.style.visibility = ""), this.unmuteAudioContext(), !this.loadedConfig || this.loadedConfig.autoplay === c.On || this.loadedConfig.autoplay !== c.Off && "running" === this.audioState()) {
                if (this.play(), "running" !== this.audioState()) {
                    this.loadedConfig && this.loadedConfig.unmuteOverlay === f.Hidden || (this.unmuteOverlay.style.display = "block"), this.container.addEventListener("click", this.unmuteOverlayClicked.bind(this), {
                        once: !0
                    });
        ...
        destroy() {
            this.instance && (this.instance.destroy(), this.instance = null, this.metadata = null, this._readyState = u.HaveNothing, console.log("Ruffle instance destroyed."))
        }
        checkOptions(e) {
        ...
        async reloadWithCanvasRenderer() {
            if (this.loadedConfig && this.loadedConfig.preferredRenderer !== h.Canvas) {
                const e = { ...this.loadedConfig,
                    preferredRenderer: h.Canvas
                };
                await this.load(e)
            } else {
                if (!this.loadedConfig) throw new Error("Cannot reload if load wasn't first called");
            ...
            if (e = this.checkOptions(e), this.element.isConnected && !this.isUnusedFallbackObject()) {
                if (!fn(this.element)) try {
                    this.loadedConfig = { ...R,
                        ...
                        ...this.config,
                        ...e
                    }, this.loadedConfig.backgroundColor && this.loadedConfig.wmode !== p.Transparent && (this.container.style.backgroundColor = this.loadedConfig.backgroundColor), await this.ensureFreshInstance(), "url" in e ? (console.log(`Loading SWF file ${e.url}`), this.swfUrl = new URL(e.url, document.baseURI), this.instance.stream_from(this.swfUrl.href, rn(e.parameters))) : "data" in e && (console.log("Loading SWF data"), delete this.swfUrl, this.instance.load_data(new Uint8Array(e.data), rn(e.parameters), e.swfFileName || "movie.swf"))
                } catch (e) {
        ...
        confirmReloadSave(e, n, t) {
            if (hn(n) && localStorage[e]) {
                ...
                if (a.includes(o) && e.startsWith(r)) {
                    return void(confirm(je("save-reload-prompt", {
        ...
        populateSaves() {
            ...
            e.textContent = "", Object.keys(localStorage).forEach((n => {
                ...
                t && a && hn(a) && e.appendChild((0, y.jsx)(this.SaveRow, {
                    rowKey: n,
                    solName: t,
                    solData: a
                }))
        ...
        pointerDown(e) {
            this.pointerDownPosition = new on(e.pageX, e.pageY), this.pointerMoveMaxDistance = 0, this.startLongPressTimer()
        }
        clearLongPressTimer() {
        ...
        showContextMenu(e) {
            ...
            if ("contextmenu" === e.type ? (this.contextMenuSupported = !0, document.documentElement.addEventListener("click", this.hideContextMenu.bind(this), {
                    ...
                    once: !0
                }), e.stopPropagation()), [!1, v.Off].includes(this.loadedConfig ? .contextMenu ? ? v.On) || this.isTouch && this.loadedConfig ? .contextMenu === v.RightClickOnly || this.contextMenuForceDisabled) return;
            ...
            for (const e of this.contextMenuItems())
                if (null === e) this.contextMenuElement.appendChild((0, y.jsx)("li", {
            ...
            this.contextMenuElement.style.top = `${s}px`, l ? (this.contextMenuElement.style.right = n.width - i + "px", this.contextMenuElement.style.left = "") : (this.contextMenuElement.style.right = "", this.contextMenuElement.style.left = `${i}px`)
        }
        hideContextMenu() {
        ...
        unmuteAudioContext() {
            an || (navigator.maxTouchPoints < 1 ? an = !0 : "audioSession" in navigator ? navigator.audioSession.type = "playback" : this.container.addEventListener("click", (() => {
                if (an) return;
                const e = this.instance ? .audio_context();
                if (!e) return;
                const n = new Audio;
        ...
        addOpenInNewTabMessage(e, n) {
            ...
            i.innerText = je("open-in-new-tab"), i.onclick = () => e(t), o.appendChild(i), r.appendChild(o), a.appendChild(r), this.container.prepend(a)
        }
        ...
        displayMessage(e) {
            ...
            o.id = "continue-btn", o.textContent = je("continue"), r.appendChild(o), t.appendChild(r), n.appendChild(t), this.container.prepend(n), this.container.querySelector("#continue-btn").onclick = () => {
        ...
        displayClipboardModal(e) {
            ...
            n && (n.textContent = je("clipboard-message-description", {
        ...
        setMetadata(e) {
            this.metadata = e, this._readyState = u.Loaded, this.hideSplashScreen(), this.element.dispatchEvent(new CustomEvent(sn.LOADED_METADATA)), this.element.dispatchEvent(new CustomEvent(sn.LOADED_DATA))
        }
    }
    ...
    function hn(e) {
        try {
            const t = atob(e);
            return 0 === (n = t).charCodeAt(0) && 191 === n.charCodeAt(1) && "TCSO" === n.slice(6, 10) && [0, 4, 0, 0, 0, 0].every(((e, t) => n.charCodeAt(10 + t) === e))
        } catch (e) {
            return !1
        }
        var n
    ...
    class Sn extends HTMLElement {
        ...
        constructor() {
            super(), Rn.set(this, void 0), xn.set(this, null), jn(this, Rn, new sn(this, (() => this.debugPlayerInfo()), (e => {
                try {
            ...
            })), "f"), zn(this, Rn, "f").addFSCommandHandler(((e, n) => {
    ...
    class qn extends Sn {
        ...
        static isInterdictable(e) {
            ...
            return o === "clsid:D27CDB6E-AE6D-11cf-96B8-444553540000".toLowerCase() ? !Array.from(e.getElementsByTagName("object")).some(qn.isInterdictable) && !Array.from(e.getElementsByTagName("embed")).some(En.isInterdictable) : !o && De(r, t)
        }
    ...
    var Fn, Pn, Dn, Mn, $n, On, In, Tn, Wn = function(e, n, t, a, r) {
            if ("m" === a) throw new TypeError("Private method is not writable");
            if ("a" === a && !r) throw new TypeError("Private accessor was defined without a setter");
            if ("function" == typeof n ? e !== n || !r : !n.has(e)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
            return "a" === a ? r.call(e, t) : r ? r.value = t : n.set(e, t), t
    ...
    class Nn {
        ...
        install(e) {
            ...
            Ln(this, Fn, "f").push(n), Ln(this, Pn, "f")[e.type] = n, Object.defineProperty(this, n.type, {
                configurable: !0,
                enumerable: !1,
                value: n
            }), this[t] = n
    ...
    class Un extends Nn {
        constructor(e, n, t) {
            super(), Mn.set(this, void 0), $n.set(this, void 0), On.set(this, void 0), Wn(this, Mn, e, "f"), Wn(this, $n, n, "f"), Wn(this, On, t, "f")
        }
        get name() {
            return Ln(this, Mn, "f")
        }
    ...
    class Bn {
        ...
        install(e) {
            ...
            Ln(this, In, "f").push(e), Ln(this, Tn, "f")[e.name] = e, Object.defineProperty(this, e.name, {
                configurable: !0,
                enumerable: !1,
                value: e
            }), this[n] = e
        ...
        refresh() {}[(In = new WeakMap, Tn = new WeakMap, Symbol.iterator)]() {
    ...
    const Hn = window.RufflePlayer ? .config ? ? {},
        Jn = function(e) {
            let n = Me ? .href ? ? "";
            return !$e && "publicPath" in e && null !== e.publicPath && void 0 !== e.publicPath && (n = e.publicPath), "" === n || n.endsWith("/") || (n += "/"), n
        }(Hn) + "ruffle.js";
    let Zn, Kn, Qn, Gn;
    ...
    function Xn() {
        Qn = Qn ? ? document.getElementsByTagName("iframe"), Gn = Gn ? ? document.getElementsByTagName("frame"), [Qn, Gn].forEach((e => {
            for (const n of e) {
    ...
    async function et(e, n) {
        ...
        if ($e || void 0 === t.documentElement.dataset.ruffleOptout)
            if ($e) e.RufflePlayer || (e.RufflePlayer = {}), e.RufflePlayer.config = { ...Hn,
                ...e.RufflePlayer.config ? ? {}
            };
            else if (!e.RufflePlayer) {
            const n = t.createElement("script");
            n.setAttribute("src", Jn), n.onload = () => {
    ...
    function tt() {
        ("favorFlash" in Hn && !1 === Hn.favorFlash || "ruffle.js" === (navigator.plugins.namedItem("Shockwave Flash") ? .filename ? ? "ruffle.js")) && (Yn(), Xn(), new MutationObserver((function(e) {
            e.some((e => Array.from(e.addedNodes).some((e => ["EMBED", "OBJECT"].includes(e.nodeName) || e instanceof Element && null !== e.querySelector("embed, object"))))) && (Yn(), Xn())
        })).observe(document, {
            childList: !0,
            subtree: !0
        }))
    ...
    try {
        ...
        let t;
        window.RufflePlayer instanceof s ? t = window.RufflePlayer : (t = new s(window.RufflePlayer), window.RufflePlayer = t), t.sources[e] = at, at.options = n, !1 !== (!("polyfills" in t.config) || t.config.polyfills) && at.pluginPolyfill()
    }("local", {
        onFirstLoad: () => {
            r.p = function(e) {
                let n = rt ? .href ? ? "";
